import HjulComponent from "./HjulComponent";

export default function HjulHeroComponent() {
  return (
    <div className="bg-white">
      <div className="relative isolate pb-12 px-6 lg:px-8">
        <div
          aria-hidden="true"
        ...
        <div className="mx-auto max-w-2xl py-8 sm:py-12 lg:py-16">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 pb-16">
