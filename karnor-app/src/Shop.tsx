...
import { categories, formatMaterialAge, formatMaterialMeta, formatPrice, materials } from './shop/materials';
...
export default function Shop() {
  ...
  return <main className="shop-page shop-ui" id="shop-main">
    <div className="shop-preview-banner"><span className="shop-preview-dot" /> En liten förhandstitt på vår materialbutik <span className="shop-preview-divider">·</span><span>Exempelpriser – köp öppnar senare</span></div>
    <div className="shop-container">
      ...
      <section id="material" className="shop-catalog" aria-labelledby="material-title">
        ...
        <p className="shop-catalog-disclaimer">Butiken visar våra uppladdade material tillsammans med exempelprodukter. Alla priser är exempelpriser. Favoriter och varukorg återställs när sidan laddas om.</p>
      </section>
